...
router.post('/:id/resubmit-department', async (req, res, next) => {
  try {
    ...
    // would authenticate the request and use the actual session user). This map uses the ACTUAL
    // seeded role strings from server/db/seed-users.js (which use hyphens, e.g. 'logistics-manager',
