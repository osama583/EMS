...
export const MOCK_REQUEST_OPTIONS: readonly RequestOption[] = [
  ...
  { id: 'food-lunch', kind: 'fnb', label: 'Lunch', servingUnitId: 'serving-pax', dietaryInformationId: 'dietary-standard', active: true },
  { id: 'food-dinner', kind: 'fnb', label: 'Dinner', servingUnitId: 'serving-pax', dietaryInformationId: 'dietary-standard', active: true },
  { id: 'food-refreshments', kind: 'fnb', label: 'Refreshments', servingUnitId: 'serving-pax', dietaryInformationId: 'dietary-standard', active: true },
  { id: 'food-coffee-tea', kind: 'fnb', label: 'Coffee / Tea', servingUnitId: 'serving-pax', dietaryInformationId: 'dietary-standard', active: true },
  { id: 'food-buffet', kind: 'fnb', label: 'Buffet', servingUnitId: 'serving-pax', dietaryInformationId: 'dietary-standard', active: true },
  { id: 'food-other', kind: 'fnb', label: 'Other', active: true },
  ...
  { id: 'tour-area-campus', kind: 'campusTourArea', label: 'Campus overview', estimatedDuration: 45, active: true },
  { id: 'tour-area-labs', kind: 'campusTourArea', label: 'Labs and classrooms', estimatedDuration: 45, active: true },
  { id: 'tour-area-library', kind: 'campusTourArea', label: 'Library and student spaces', estimatedDuration: 30, active: true },
  { id: 'tour-area-innovation', kind: 'campusTourArea', label: 'Innovation labs', estimatedDuration: 30, restrictions: 'Subject to lab availability.', active: true },
  { id: 'tour-map-main', kind: 'campusTourMap', label: 'Main Campus Visitor Map', mapUrl: '/assets/media/apu-campus-map.pdf', accessNotes: 'Use the marked visitor route and accessible lifts.', active: true },
