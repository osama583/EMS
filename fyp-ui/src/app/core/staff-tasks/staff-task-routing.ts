...
// This user's staff-task routing key, or null if they have no task queue (most roles don't — only
// cafeteria-staff and staff/lecturer/head-of-department assigned to one of the 5 routed Service
// departments do).
