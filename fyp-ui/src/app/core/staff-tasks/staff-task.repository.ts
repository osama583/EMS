...
const STAFF_EMAIL: Readonly<Partial<Record<UserRole, string>>> = {
  ...
  [UserRole.FmbWaterServicesStaff]: 'fmb.water.staff@demo.apu.edu.my',
...
const MOCK_TASKS: readonly StaffTask[] = [
  ...
  task('water-1', UserRole.FmbWaterServicesStaff, 'EVT-260142', 'APU Cultural Night 2026', 'Mineral Water with APU Logo', 'Delivery requirement', 'Prepare and deliver before registration', '8 Aug 2026 - by 3:00 PM', 'Atrium', 'assigned', '180 bottles'),
  task('water-2', UserRole.FmbWaterServicesStaff, 'EVT-260137', 'Future Tech Showcase', 'Mineral Water Normal', 'Delivery requirement', 'Place at exhibitor stations', '12 Aug 2026 - by 9:30 AM', 'Design Studio', 'in-progress', '96 bottles'),
  task('water-h1', UserRole.FmbWaterServicesStaff, 'EVT-260082', 'Graduate Networking Evening', 'Mineral Water Normal', 'Delivery requirement', 'Delivered to guest tables', '23 Jul 2026 - 4:00 PM', 'Auditorium 2', 'completed', '120 bottles'),
  ...
  task('caf-2', UserRole.CafeteriaStaff, 'EVT-260118', 'Graduate Networking Evening', 'Refreshment order', 'Serving unit', 'Individual packs', '6 Aug 2026 · 5:00 PM–7:30 PM', 'Auditorium 2', 'in-progress', '90 packs'),
  ...
  task('log-2', UserRole.LogisticsStaff, 'EVT-260131', 'Entrepreneurship Bootcamp', 'Registration desk setup', 'Inventory item', 'Folding tables', '7 Aug 2026 · 8:00 AM–9:00 AM', 'Design Studio', 'in-progress', '8 / 12 tables'),
  ...
  task('av-2', UserRole.AvTechnician, 'EVT-260118', 'Graduate Networking Evening', 'Presentation setup', 'Equipment', 'Projector, lectern microphone and confidence monitor', '6 Aug 2026 · 3:30 PM–8:00 PM', 'Auditorium 2', 'in-progress'),
  ...
  task('photo-2', UserRole.PhotographyStaff, 'EVT-260118', 'Graduate Networking Evening', 'Event photography', 'Personnel', '1 photographer', '6 Aug 2026 · 5:00 PM–8:00 PM', 'Auditorium 2', 'in-progress'),
  ...
  task('transport-2', UserRole.TransportStaff, 'EVT-260126', 'Airport Welcome Programme', 'Airport transfer', 'Passengers', '12 pax · 15-seat van', '5 Aug 2026 · 9:00 AM–12:30 PM', 'KLIA → APU Residence', 'in-progress'),
